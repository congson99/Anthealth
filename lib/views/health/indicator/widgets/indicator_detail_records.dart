...
class IndicatorDetailRecords extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      ...data.map((mData) => buildComponent(mData, context)).toList()
    ]);
  }

  Widget buildComponent(IndicatorData mData, BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          child: Container(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    Text(
                        (fixed != 10)
                            ? mData.getValue().toStringAsFixed(fixed)
                            : ((mData.getValue() ~/ 1).toString() +
                                '/' +
                                ((mData.getValue() * 1000) % 1000)
                                    .toStringAsFixed(0)),
                        style: Theme.of(context)
                            .textTheme
                            .bodyText1!
                            .copyWith(color: AnthealthColors.primary1)),
                    if (isDirection == true) SizedBox(width: 8),
                    if (isDirection == true)
                      Image.asset("assets/app_icon/direction/right_pri1.png",
